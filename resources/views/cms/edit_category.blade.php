            ...
            <div class="col-md-12">
                ...
                <div class="card" >
                    <div class="content table-responsive table-full-width">
                                    <form method="POST" action="{{URL::to('/edit-single-category')}}?id={{$category->id}}" enctype="multipart/form-data">
             {{ csrf_field() }}
                    <div class="form-group">
                        <label for="inputName"  class="control-label">Title</label>
                        <input type="text" value="{{$category->title}}" class="form-control " name="title" id="inputName">
                    </div>
                    <div class="form-group">
                  ...
                  <input type="file" class="form-control" name="image">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="inputEmail"> {{$category->description}}</textarea>
