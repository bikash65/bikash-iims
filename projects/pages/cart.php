...
<title>Mahalaxmi Cold Store</title>
    ...
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
		...
		<link rel="stylesheet" type="text/css" href="../projects/assets/css/demo.css">
        	...
        	<div class="row">
             	<div class="col-md-12 breadcrumb_info" align="center">
        			...
        			<ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="order.php">chicken boneless breast</a></li>
                      ...
                      <div class="col-md-12 ">
                      	...
                      	<div class="col-md-10 ">
                                ...
                                <div class="cheout_qty ">
                                    ...
                                    <div class=" cheout_qty2 ">
                                            <button type="button" class="edit2" data-toggle="modal" data-target="#myModal">
                                                        <a href="#"style="display:inline-block;"><img src="../icons/edit.png"></a>
                                                    </button>
                            ...
                            <div class="total" align="right">
                            	<h3>Total : <span>Rs. 5214/-</span></h3>
                                
                                <input type="button" value="CANCEL" class="cancel_btn">
                                <input type="button" value="CHECKOUT" class="checkout_btn">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="form-group">
     <input type="submit" name="submit" value="Update" class="Log_in" />
  </div>
      </div>
                        </form>
