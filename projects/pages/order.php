                        ...
                        <ul class="nav navbar-nav main-nav nav_ul">
                             ...
                             <li class="btn_hov">
                        		...
                        		<div class="dropdown account_us">
                                  <button class="account_user" type="button" data-toggle="dropdown"><img src="../icons/user.png"> Sachin
        	...
        	<div class="row">
             	<div class="col-md-12 breadcrumb_info" align="center">
        			...
        			<ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="product_category.php">chicken</a></li>
                        <li class="breadcrumb-item active">chicken boneless breast</li>
        			</ol>
                 </div><!-- breadcrumb_info -->
                  ...
                  <div class=" order">
                      <div class="col-md-4 product_type2 ">
                    	<div class="prd1 ">
                            <img src="../icons/chicken3.jpg" class="img-responsive">
                        </div>
                      ...
                      <div class="col-md-8 ">
                      	<div>     	
                            <h1>Chicken Boneless Breast</h1>
                            <h3>FRESH NEVER FROZEN</h3>
                            <h4>Price : Rs. 450/- per kg</
                        </div>
                        ...
                        <div class="order_qty2"> 
                        	<form>
                                <input type="number" class="ord_btn" value="5" step=".1"/>
                                <span>* Must be above 5 kg </span><br>
                                
                                <select name="Date" class="ord_btn ord_btn2">
                                	<option value="volvo">Date</option>
                                    <option value="saab">Fri</option>
                                    <option value="fiat">Sat</option>
                                    <option value="audi">Sun</option>
                                </select>
                                <select name="Time" class="ord_btn ord_btn2">
                                	<option value="volvo">Time</option>
                                    <option value="saab">8:00am</option>
                                    <option value="fiat">9:00am</option>
                                    <option value="audi">10:00am</option>
                                    <option value="audi">11:00am</option>
                                    <option value="audi">12:00pm</option>
                                    <option value="audi">13:00pm</option>
                                    <option value="audi">14:00pm</option>
                                    <option value="audi">15:00pm</option>
                                    <option value="audi">16:00pm</option>
                                    <option value="audi">17:00pm</option>
                                    <option value="audi">18:00pm</option>
                                </select>
                                <br><br>
                                <input type="radio" name="deliver"> <i>Self Pick Up</i><br>
                                <input type="radio" name="deliver"> <i>Home Delivary</i><br>
                                <p> *Free Home Delivery in kathmandu Valley only</p>
                                <input type="button" class="cart_btn" value="ADD TO CART" >
                            </form>
                        </div>
                         ...
                         <div style="height:3px; background-color:#C52B29;"> 
                            ...
                            <div class="contact_det "> 
                            	<div class="contact_de">
                                     ...
                                     <h6><img src="../icons/address.png"> <b>Address</b> : Mahalaxmi, Lalitpur</h6>                                            
                                </div>
                                
                                <div class="contact_de">
                                     <h1>CUSTOMER SUPPORT</h1> 
                                     <p>Mahalaxmi Cold Store bring you 24/7 hrs online support</p>
                                     <h6><img src="../icons/call.png"> <b>Phone </b>: 01-5510123 </h6> 
                                     <h6><img src="../icons/mob.png" > <b>Mobile</b>: 9841-33-0747</h6>                                            
                                </div>
...
<!--nice scroll    -->
<script src="../projects/assets/js/jquery.nicescroll.js"></script>
